...
namespace Microsoft.Xna.Framework.Input
{
    public partial class MouseCursor
    {
        ...
        /// <summary>
        /// Creates a MouseCursor from a custom resource ID for UWP.
        /// Used with CoreCursorType.Custom and Win32 .res resources.
        /// </summary>
        /// <param name="resourceId">The resource ID defined in the .res file (e.g., 101, 102)</param>
        /// <returns>A MouseCursor wrapping the custom cursor, or null if the resource is not found</returns>
        public static MouseCursor FromResourceId(uint resourceId)
        {
            try
            {
                return new MouseCursor(new CoreCursor(CoreCursorType.Custom, resourceId));
            }
            catch
            {
                return null;
