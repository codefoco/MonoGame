...
internal static class Sdl
{
    ...
    public static IntPtr NativeGLESLibrary = FuncLoader.LoadLibrary("libGLESv2.so");
    ...
    private static IntPtr TrySystemSDL()
    {
        ...
        // for newer versions and fallback to old ones
        string[] sdlVersions = {
            "libSDL2-2.0.so.0.3200.8",
        ...
        string [] prefixes = LibraryPrefixPath;
